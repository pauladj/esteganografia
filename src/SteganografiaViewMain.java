...
public class SteganografiaViewMain extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SteganografiaViewMain frame = new SteganografiaViewMain();
	...
	public SteganografiaViewMain() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					String texto = SteganografiaPrograma.getSteganografiaPrograma().obtenerTexto(txtCuserspauladjdesktopimagenpng_1.getText());
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					SteganografiaPrograma.getSteganografiaPrograma().esconderTexto(txtCuserspauladjdesktopimagenpng.getText(), textPane.getText(), txtCuserspauladjdesktop.getText());
				} catch (IOException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
