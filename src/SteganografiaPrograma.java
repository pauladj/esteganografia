...
public class SteganografiaPrograma {

	public static SteganografiaPrograma unSteganografiaPrograma;

	private SteganografiaPrograma(){

	}

	public static SteganografiaPrograma getSteganografiaPrograma() {
		if(unSteganografiaPrograma == null) {
			unSteganografiaPrograma = new SteganografiaPrograma();
		}
		return unSteganografiaPrograma;
	}
...
/**/
		...
		for(int f=1;f<n.getWidth() && i<resultado.length();f++) {
			...
			/**/
				...
				//Se cambia el último digito de los canales por el índicado por "i"
